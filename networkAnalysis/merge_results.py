...
def merge_results(from_folder, to_folder):
    def merge_batches(attacker_type, distr_strategy, attack_model, num_compromised_nodes, r_keyset_size):
        ...
        if distr_strategy != 'cff' and distr_strategy != 'greedy' and distr_strategy != 'wp':
    ...
    for attacker_type in ['tpa', 'dpa']:
        for distr_strategy in ['rd', 'mhd', 'cff', 'greedy', 'wp']:
...
if __name__ == '__main__':
    ...
    if platform.system() == 'Darwin':
        m_result_folder = '/Users/xingyuzhou/Downloads/dpa_wp_our_106_22'
    else:
